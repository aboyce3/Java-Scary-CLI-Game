...
public class Adult extends Npc { 
  ...
  public Adult(String n, String d){
    super(n,d);
  }
  ...
  public void react(Item.ItemActions haunting){
    if(haunting == Item.ItemActions.POSSESS){
      scaredLevel = scaredLevel + (r.nextInt(25-10) + 10);
      runAway();
    }if(haunting == Item.ItemActions.THROW){
      scaredLevel = scaredLevel + (r.nextInt(40-20) + 20);
      runAway();
    }if(haunting == Item.ItemActions.SHAKE){
      scaredLevel = scaredLevel + (r.nextInt(15-5) + 20);
      runAway();
    }
  }
}
